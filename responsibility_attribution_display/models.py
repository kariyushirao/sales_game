...
class Subsession(BaseSubsession):
	def creating_session(self):
		treatments = itertools.cycle(['histogram', 'heatmap', 'words'])
		...
		if self.round_number == 1:
			for p in self.get_players():
				...
				p.stim_dots_current = people[stim_id]['dots_current']
...
class Player(BasePlayer):
	...
	comprehension5 = models.IntegerField(
		choices=[[1, 'from 3 to 7'], [2, 'from 4 to 10'], [3, 'from 0 to 9']],
		widget=widgets.RadioSelect
		)
	...
	stim_dots_current = models.CharField()
